    ...
    <body bgcolor="#E2C2CB">
      ...
      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/recruitment","root","");
         ...
         String stat="c";
          ...
          st.executeUpdate("insert into Com(CName,CAddress,CPost,CCriteria,CUsername,CPassword,CEmail,CContact,CCutoff,ACutoff,lastdate) values('"+request.getParameter("comname")+"','"+request.getParameter("comaddress")+"','"+request.getParameter("compost")+"','"+request.getParameter("comcriteria")+"','"+request.getParameter("comusername")+"','"+request.getParameter("comusername")+"','"+request.getParameter("comemail")+"','"+request.getParameter("comcontact")+"','"+request.getParameter("comcutoff")+"','"+request.getParameter("acutoff")+"','"+request.getParameter("lastdate")+"')");
          st.close();
          st2.close();
