...
<div class="px-4 py-5 my-5 text-center mt-3">
    ...
    <h1 class="display-5 fw-bold">One Click Apply</h1>
    <div class="col-lg-6 mx-auto">
      ...
      <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
            ...
            if (rs.next()) {
                ...
                category = "Fresher";
                    ...
                    <form method="post" action="savequickapply.jsp" name="form1" onsubmit="return check()">
                        <table border=0 cellpadding=3 cellspacing=0 width =81% align=center>
                            <tr bgcolor =white wdth =100%>
                                <td colspan="2" bgcolor="#E2E0CF"><div align="center"><font color="#386A78" size="5"><strong>Profile</strong></font></div></td>
                            </tr>
     ...
     if (s11.equalsIgnoreCase("Fresher")) {
                            ...
                            <tr>
                                <td height="49" colspan=2 align="center" ><input  class="btn btn-outline-dark" TYPE="submit" value="Apply"></td>
                            </tr>
                        </table>
                    </form>
