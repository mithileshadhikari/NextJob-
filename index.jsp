 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="img/office5.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
  ...
  <h1 align="center">Top Companies</h1>
    <div class="col-lg-4 text-center mt-5">
      <img class="bd-placeholder-img rounded-circle" width="140" height="140"  src="img/amazon.png" alt="">
     
      <p><a class="btn btn-secondary" href="#">View details »</a></p>
    </div><!-- /.col-lg-4 -->
    <div class="col-lg-4 text-center mt-5">
      <img class="bd-placeholder-img rounded-circle" width="140" height="140"  src="img/facebook1.png" alt="">
      
      <p><a class="btn btn-secondary" href="#">View details »</a></p>
    </div><!-- /.col-lg-4 -->
    <div class="col-lg-4 text-center mt-5">
      <img class="bd-placeholder-img rounded-circle" width="140" height="140"  src="img/netflix.png" alt="">
      
      <p><a class="btn btn-secondary" href="#">View details »</a></p>
    </div><!-- /.col-lg-4 -->
    
     <div class="col-lg-4 text-center mt-5">
      <img class="bd-placeholder-img rounded-circle" width="140" height="140"  src="img/microsoft.png" alt="">
     
      <p><a class="btn btn-secondary" href="#">View details »</a></p>
    </div><!-- /.col-lg-4 -->
    <div class="col-lg-4 text-center mt-5">
      <img class="bd-placeholder-img rounded-circle" width="140" height="140"  src="img/visa.png" alt="">
      
      <p><a class="btn btn-secondary" href="#">View details »</a></p>
    </div><!-- /.col-lg-4 -->
    <div class="col-lg-4 text-center mt-5">
      <img class="bd-placeholder-img rounded-circle" width="140" height="140"  src="img/twitter.png" alt="">
...
<div class="px-4 py-5 my-5 text-center mt-0">
  ...
  <hr class="featurette-divider">
    <div class="row featurette ml-auto" >
      ...
      <div class="col-md-5">
       <img  width="500" height="350" src="img/post1.jpg">
      </div>
    </div>
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5 order-md-1">
        <img  width="500" height="350" src="img/post3.jpg">
      </div>
    </div>
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
       <img  width="500" height="350" src="img/post2.jpg">
      </div>
    </div>
